...
class BaseDeclarativeApiManager(object):
    ...
    def get(self, *args, **kwargs):
        ...
        :return: A list containing specified entity object fetched from API
        """
        return self.entity(node=self.node, json_properties=self.api_manager.get(**kwargs))
    ...
    def post(self, *args, **kwargs):
        ...
        :return: a
        """
        return self.entity(node=self.node, json_properties=self.api_manager.post(**kwargs))
    ...
    def delete(self, *args, **kwargs):
        ...
        """
        return self.entity(node=self.node, json_properties=self.api_manager.delete(**kwargs))
    ...
    def patch(self, *args, **kwargs):
        ...
        :param id: the id of the entity's element to delete
        """
        return self.entity(node=self.node, json_properties=self.api_manager.patch(**kwargs))
    ...
    def put(self, *args, **kwargs):
        ...
        :param id: the id of the entity's element to delete
        """
        return self.entity(node=self.node,json_properties=self.api_manager.put(**kwargs))
